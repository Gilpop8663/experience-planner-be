...
- [ ] 체험단 링크를 등록하면 사이트명(강남맛집, 레뷰, 리뷰노트 등) ,카테고리(방문형, 배송형), 리뷰 등록기간, 예약하기, 상품 제공내역, 위치, 자세히 보기 링크를 제공한다.
- [ ] 링크 말고 직접 정보(제목, 사이트, 카테고리, 리뷰 등록기간(필수), 협찬비, 예약하기, 상품 제공내역, 위치, 자세히보기 링크)를 입력하여 등록이 가능하다.
